...
![weighted graph](./assets/weighted graph.png)
...
![](./assets/img-wuwe-y.png)

![](./assets/img-wuwe-u.png)
...
![](./assets/img-wuwe-i.png)

**广度优先搜索的具体实现方式用到了之前所学过的线性数据结构——队列** 。具体过程如下图所示：

**第 1 步：**

![](./assets/img-wuwe-o.png)

**第 2 步：**

![](./assets/img-wuwe-p.png)

**第 3 步：**

![](./assets/img-wuwe-wq.png)

**第 4 步：**

![](./assets/img-wuwe-ww.png)

**第 5 步：**

![](./assets/img-wuwe-we.png)

**第 6 步：**

![](./assets/img-wuwe-wr.png)

### 深度优先搜索

深度优先搜索就是“一条路走到黑”，从源顶点开始，一直走到没有后继节点，才回溯到上一顶点，然后继续“一条路走到黑”，如下图所示：

![](./assets/img-wuwe-wt.png)

**和广度优先搜索类似，深度优先搜索的具体实现用到了另一种线性数据结构——栈** 。具体过程如下图所示：

**第 1 步：**

![](./assets/img-wuwe-wy.png)

**第 2 步：**

![](./assets/img-wuwe-wu.png)

**第 3 步：**

![](./assets/img-wuwe-wi.png)

**第 4 步：**

![](./assets/img-wuwe-wo.png)

**第 5 步：**

![](./assets/img-wuwe-wp.png)

**第 6 步：**

![](./assets/img-wuwe-eq.png)
