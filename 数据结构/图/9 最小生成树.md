...
在数据结构与算法的**图论**中，(生成)最小生成树算法是一种常用并且和生活贴切比较近的一种算法。

但是可能很多人对概念不是很清楚，什么是最小生成树：
...
![](./assets/img-wiou-r.jpg)
![](./assets/img-wiou-t.jpg)
...
![](./assets/img-wiou-y.jpg)
![](./assets/img-wiou-u.jpg)
...
public class prim {
    ...
    public static void main(String[] args) {
        ...
        int max = 66666;
        String[] city_name = {"北京", "武汉", "南京", "上海", "杭州", "广州", "深圳"};
        int[][] city = {
        ...
        while (!q1.isEmpty()) {
            ...
            if (is_true[newside.point1] && is_true[newside.point2]) {
                continue;
            } else {
                if (!is_true[newside.point1]) {
                    is_true[newside.point1] = true;
                    minlength += city[newside.point1][newside.point2];
                    System.out.println(city_name[newside.point1] + " " + city_name[newside.point2] + " 联通");
                    for (int i = 0; i < 7; i++) {
                        if (!is_true[i]) {
                    ...
                    is_true[newside.point2] = true;
                    minlength += city[newside.point1][newside.point2];
                    System.out.println(city_name[newside.point2] + " " + city_name[newside.point1] + " 联通");
                    for (int i = 0; i < 7; i++) {
                        if (!is_true[i]) {
    ...
    public static void main(String[] args) {
        ...
        while (!q1.isEmpty())//执行算法
        {
            ...
            if (search(p1) != search(p2)) {
                union(p1, p2);
                System.out.println(city_name[p1] + " " + city_name[p2] + " 联通");
