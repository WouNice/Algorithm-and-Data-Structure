...
二叉树的两种存储结构，一种是「链式存储结构」，另一种是「顺序存储结构」。线段树也可以使用这两种存储结构来实现。
...
-   [线段树（Segment Tree）精讲及python实现](https://blog.csdn.net/baidu_33164415/article/details/135320789)
-   [谁能通俗讲解一下线段树的算法? ](https://www.zhihu.com/question/662665415/answer/3587302759)
-   [线段树详解](https://www.cnblogs.com/xenny/p/9801703.html)
-   [python 线段树入门小结](https://leetcode.cn/discuss/post/3571450/fen-xiang-python-xian-duan-shu-ru-men-xi-0ys6/)
